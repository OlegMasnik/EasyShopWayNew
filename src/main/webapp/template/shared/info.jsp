...
<div layout="row" flex="none">
	...
	<div flex layout="column">
		...
		<form method="POST" action="cabinet/image-upload"
			...
			<md-button type="submit" ng-click='sendLoginData()'>Save</md-button>
			<md-button>Cancel</md-button> </md-card-actions>
		</form>
		</md-card>

		<md-card flex> <md-card-title> <md-card-title-text>
		...
		</md-card-title> <md-card-actions layout="row" layout-align="end center">
		<md-button>Save</md-button> <md-button>Cancel</md-button> </md-card-actions> </md-card>
	</div>
</div>