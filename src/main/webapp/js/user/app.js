...
function exportScript(lang){
	(function (f) {
	    ...
	    var s = f.win
	        ...
	        , A;
	    q(z.lang, {
	        printChart: lang == 'en' ? "Print chart" : "Друкувати графік"
	        , downloadPNG: lang == 'en' ? "Download PNG image" : "Завантажити PNG зображення"
	        , downloadJPEG: lang == 'en' ? "Download JPEG image" : "Завантажити JPEG зображення"
	        , downloadPDF: lang == 'en' ? "Download PDF document": "Завантажити PDF зображення"
	        , downloadSVG: lang == 'en' ? "Download SVG vector image" : "Завантажити SVG зображення"
	        , contextButtonTitle: lang == 'en' ? "Chart context menu" : "Опції"
	    });
	    z.navigation = {
	        menuStyle: {
