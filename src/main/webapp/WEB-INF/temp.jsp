        ...
        <body ng-app="SearchApp" layout="column">
            ...
            <md-toolbar class="md-hue-2">
                <div class="md-toolbar-tools" layout="row" ng-controller="AppCtrl" md-whiteframe="4">
                    ...
                    <div layout="row">
                        <a flex class="logo" href="/EasyShopWayNew/home"><img alt="EasyShopWay" src="images/logo/logo.gif"></a>
                    </div>
                    <span flex></span>

                    <c:choose>
                        <c:when test="${user == null}">
                            <md-button class="md-raised" ng-click="showLogInForm($scope, $mdDialog)"> LogIn </md-button>
                            <md-button class="md-raised" ng-click="showRegistrationInFrom($scope, $mdDialog)">
                                SignUp </md-button>
                        </c:when>
                        <c:otherwise>
            ...
            <script>
                ...
                function DemoCtrl($timeout, $q, $log, $scope, $http) {
                    ...
                    self.click = function (item) {
                        ...
                        $http.get('/EasyShopWayNew/searchProducts?mapId=' + $scope.maps, config).success(
