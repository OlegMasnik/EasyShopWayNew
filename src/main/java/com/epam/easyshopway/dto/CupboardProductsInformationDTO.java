...
public class CupboardProductsInformationDTO extends SuperDTO {
	...
	public List<CupboardProductsInformationDTO> getAllProductbyCupdoardId(
		...
		List<CupboardProductsInformationDTO> users = new Transformer<CupboardProductsInformationDTO>(
				CupboardProductsInformationDTO.class).fromRStoCollection(resultSet);
		statement.close();
		return users;
	}
